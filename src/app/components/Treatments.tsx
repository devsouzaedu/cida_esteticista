...
const Treatments = () => {
  return (
    <section id="tratamentos" className="section bg-gray-100">
      <div className="container mobile-padding">
        ...
        <div className="mt-8 md:mt-12 text-center">
          <p className="mobile-text text-black mb-4 md:mb-6">Interessada em algum tratamento? Entre em contato para uma avaliação personalizada!</p>
          <a 
