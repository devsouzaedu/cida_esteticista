    ...
    <section id="sobre" className="section bg-gray-50">
      <div className="container mobile-padding">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div>
            <h3 className="text-xl sm:text-2xl font-semibold text-[--primary] mb-4">Experiência e Dedicação</h3>
            <p className="mobile-text text-[--text-light] mb-4 sm:mb-6">
            ...
            <p className="mobile-text text-[--text-light]">
