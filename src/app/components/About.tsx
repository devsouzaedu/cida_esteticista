...
const About = () => {
  return (
    <section id="sobre" className="section bg-gray-900">
      <div className="container mobile-padding">
        <h2 className="mobile-heading font-bold text-center mb-8 md:mb-12 text-contrast-dark">Quem é Cida Esteticista</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div>
            ...
            <p className="mobile-text text-white/90 mb-4 sm:mb-6">
            ...
            <p className="mobile-text text-white/90">
